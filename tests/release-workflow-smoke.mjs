...
assert.match(workflow, /name:\s*beta13\.1-dev-diagnostic-package/, 'validated PR artifact must use the beta13.1-dev name');

console.log('beta13.1-dev release workflow smoke test passed');
