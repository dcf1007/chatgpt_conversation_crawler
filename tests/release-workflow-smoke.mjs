...
assert.match(workflow, /name:\s*beta12-dev-diagnostic-package/, 'validated PR artifact must use the beta12-dev name');

console.log('beta12-dev release workflow smoke test passed');
